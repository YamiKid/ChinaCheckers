...
class CheckersWorldHowToPlayViewController: UIViewController {
    ...
    func setupCheckersWorldUI() {
        ...
        CheckersWorldHowImageView = UIImageView(image: UIImage(named: "CheckersWorldHow"))
        ...
        let CheckersWorldDescImageView = UIImageView(image: UIImage(named: "CheckersWorldDesc3"))
        ...
        CheckersWorldDecLabel.text = "In checkers, the two sides take turns moving their pieces diagonally to empty squares. If a piece reaches the opponent's last line, it becomes a queen and can move any number of squares diagonally. The goal of the game is to capture all of the opponent's pieces or block them so that they cannot move."
